...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_notification_is_read'), table_name='notification', if_not_exists=True)
    op.drop_index(op.f('ix_notification_type'), table_name='notification', if_not_exists=True)
    op.drop_index(op.f('ix_notification_user_id'), table_name='notification', if_not_exists=True)
    op.drop_table('notification', if_not_exists=True)
